...
public class LingMouWxPayUtil {
	 ...
	 */
	public static LingMouWxPayAuthToken getTokenByAuthCode(String code) {
		LingMouWxPayAuthToken mLingmouWxPayAuthToken = null;
		StringBuilder json = new StringBuilder();
		try {
			URL url = new URL(LingMouWxPayConstant.Authtoken_URL(code));
			...
			in.close();
			// 将json字符串转成javaBean
			mLingmouWxPayAuthToken = jsonToEntity(json.toString(), LingMouWxPayAuthToken.class);
		} catch (IOException ex) {
			System.out.println("获取access_token异常");
		}
		return mLingmouWxPayAuthToken;
	}
	...
	public static String getSign(SortedMap<String, Object> map) {
		...
		buffer.append("key=" + LingMouWxPayConstant.LINGMOUWXPAY_KEY);
	 ...
	 * @return xml字符串
	 */
	public static String sendDataToXml(LingMouWxPaySendData pLingMouWxPayData) {
		xStream.autodetectAnnotations(true);
		xStream.alias("xml", LingMouWxPaySendData.class);
		return xStream.toXML(pLingMouWxPayData);
	}
